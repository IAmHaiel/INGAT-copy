    ...
    <section id="home" className="w-full py-16 md:py-24 px-6 relative overflow-hidden flex flex-col items-center">
      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col space-y-6 text-left">
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary w-fit">
            <ShieldCheck size={16} />
            <span className="text-xs font-bold tracking-wide">Secure Stellar Smart Contract Remittance</span>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-on-surface leading-[1.1]">
            Ingat sa biyahe,<br />
            <span className="text-primary">ingat din sa padala.</span>
          </h1>

          <p className="text-base md:text-lg text-on-surface-variant max-w-xl font-medium leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4">
            {!isConnected ? (
              <button
                ...
                className="bg-primary hover:bg-primary-container text-white py-4 px-8 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md hover:shadow-lg disabled:opacity-50 border-0 cursor-pointer"
              >
                <Wallet size={20} />
              ...
              <a
                href="/dashboard"
                className="bg-primary hover:bg-primary-container text-white py-4 px-8 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md hover:shadow-lg border-0 cursor-pointer"
              >
                Go to Dashboard
              </a>
            )}
            <a
              href="#how-it-works"
              className="bg-white hover:bg-surface-container text-on-surface py-4 px-8 rounded-xl font-bold text-sm flex items-center justify-center border border-outline-variant transition-all active:scale-95 shadow-sm"
            >
              See How It Works
            </a>
          </div>
