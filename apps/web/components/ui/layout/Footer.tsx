  ...
  return (
    <footer className="relative w-full py-12 px-6 border-t border-outline-variant bg-surface-container overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, var(--color-primary-container) 1.5px, transparent 1.5px)",
          backgroundSize: "32px 32px",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start gap-1">
          ...
          <p className="font-medium text-xs text-on-surface-variant">
            © 2026 INGAT Remit. Stellar APAC Hackathon.
          </p>
        </div>
        <nav className="flex gap-8 items-center">
          ...
          <a
            href="https://github.com/deveramartin/INGAT"
            target="_blank"
            rel="noopener noreferrer"
            className="text-on-surface-variant hover:text-primary transition-all flex items-center gap-1.5 text-xs font-medium"
